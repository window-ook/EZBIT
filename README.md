...
<img width="600" height="315" src="https://github.com/user-attachments/assets/c8626441-a0fa-49c5-9ccf-88cfb1cf56dc" />
...
투자 타이밍 잡기 연습, 파일럿이 만들어주는 포트폴리오 경험 등 다양한 투자를 시도해보면서 당신의 '투자 지능'을 올려보세요😊<br><br>
...
<img width="600" height="370" src="https://github.com/user-attachments/assets/4c4b532a-1350-4041-9173-d15e77b7504a" /><br>
...
**커스텀 페쳐**<br>
Fetch API 기반의 글로벌 클라이언트 apiClient와 TOKEN POST 추출 전용 클라이언트 cheerioClient를 데이터 페칭에 사용합니다.<br>
...
직접 선언하지 않고 재사용 유틸 함수로 분리하여 중앙화했습니다.<br><br>

## 🤖 컨텍스트 엔지니어링

LLM 에이전트를 개발 어시스트에 활용했습니다.<br>
Claude Code와 Gemini CLI를 사용했으며, 주 용도는 아래와 같습니다.<br>
