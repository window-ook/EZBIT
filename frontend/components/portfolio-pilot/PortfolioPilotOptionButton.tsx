...
export default function PortfolioPilotOptionButton({ title, selected, onClick }: IOptionCard) {
    return (
        <Button
            ...
            onClick={onClick}
            customClassName={`w-full py-6 flex flex-col gap-2 border ${selected ? 'border-main bg-main/20' : 'border-slate-300 bg-white'} hover:brightness-110 hover:shadow-md hover:border-main`}
        >
